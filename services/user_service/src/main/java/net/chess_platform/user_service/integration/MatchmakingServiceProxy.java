...
public class MatchmakingServiceProxy implements IEventPublisherService {
    ...
    public MatchmakingServiceProxy(@Qualifier("userEventsRabbitTemplate") RabbitTemplate rabbitTemplate) {
    ...
    public void publish(DomainEvent<?> e) {
        if (e.getCategory() == DomainEvent.Category.USER) {
            userEvents.convertAndSend(MATCHMAKING_SERVICE_ROUTING_KEY, e);
        }
    }
    ...
    public String getName() {
        return MATCHMAKING_SERVICE_ROUTING_KEY;
    }
